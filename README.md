...
* Section 4.2.1: run_base.sh
* Section 4.2.2:
  * CVP + GTA: run_ablation_cvp+gta.sh
  * Retriever-Side Loss: run_ablation_loss.sh
  * AWF: run_ablation_awf.sh

* Section 4.2.3: run_fakecorpus.sh
* Appendix D.1: run_batch.sh
* Appendix E.1: See `prompt/rag_prompt.py#L184`
* Appendix E.2: run_defense_ppl.sh
